...
export default function IncomingPage({ user }: { user: User }) {
  ...
  const handleCreate = () => {
    ...
    const material = materials.find(m => m.id === parseInt(formData.material_id));
    ...
    toast({
      title: 'Добавлено',
      description: 'Приход зарегистрирован. Материал автоматически добавлен на склад.',
    });
  };
